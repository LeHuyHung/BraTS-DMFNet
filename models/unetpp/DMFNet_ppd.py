...
class DMFNet_ppd(nn.Module):
    def __init__(self, c=4, n=32, channels=128, groups=16, norm='bn', num_classes=4):
        ...
        self.residual1 = DMFUnit(n, n, g=groups, stride=1, norm=norm)
        self.residual2 = DMFUnit(channels, channels, stride=1, norm=norm)
        self.residual3 = DMFUnit(channels * 2, channels * 2, stride=1, norm=norm)
