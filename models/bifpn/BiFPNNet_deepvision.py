...
class BiFPNNet_deepvision(nn.Module):
    def __init__(self, n_layers=1, base_unit=MFunit, c=4, n=32, channels=128,
        ...
        super(BiFPNNet_deepvision, self).__init__()
    ...
    def forward(self, x):
        ...
        final_1 = self.final_1(y1)
        final_2 = self.final_2(y2)
        y4 = torch.cat([final_1, final_2, y4], dim=1)
