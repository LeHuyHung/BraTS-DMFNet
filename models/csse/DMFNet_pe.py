...
class DMFNet_pe(nn.Module):
    def __init__(self, c=4, n=32, channels=128, groups=16, norm='bn', num_classes=4):
        ...
        reduction_ratio = 2
        self.csse_encoder1 = ProjectExciteLayer(num_channels=n, reduction_ratio=reduction_ratio)
        self.csse_encoder2 = ProjectExciteLayer(num_channels=channels, reduction_ratio=reduction_ratio)
        self.csse_encoder3 = ProjectExciteLayer(num_channels=channels * 2, reduction_ratio=reduction_ratio)
        self.csse_encoder4 = ProjectExciteLayer(num_channels=channels * 2, reduction_ratio=reduction_ratio)

        self.csse_decoder1 = ProjectExciteLayer(num_channels=channels * 2, reduction_ratio=reduction_ratio)
        self.csse_decoder2 = ProjectExciteLayer(num_channels=channels, reduction_ratio=reduction_ratio)
        self.csse_decoder3 = ProjectExciteLayer(num_channels=n, reduction_ratio=reduction_ratio)
