...
from models import DMFNet_pe, DMFNet_multiattention, DMFNet_attention, DMFNet_singleattention, DMFNet_separate_inputs,\
    DMFNet_pp_double, DMFNet_bifpn, DMFNet_multiscale_weight, DMFNet_interconnect_multiscale_weight
...
if __name__ == '__main__':
    ...
    model = DMFNet_bifpn(c=4, groups=16, channels=128, norm='sync_bn', num_classes=4)
