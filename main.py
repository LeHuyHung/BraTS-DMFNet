...
class SagemakerInference(object):
    ...
    def process(self):
        ...
        subprocess.run('CUDA_VISIBLE_DEVICES=0 python train_all.py --prefix_path=/opt/ml/input/data/train/data/ --output_path=/opt/ml/model/ --cfg=DMFNet_GDL_all --batch_size=5', shell=True)
