...
class SagemakerInference(object):
    ...
    def process(self):
        ...
        subprocess.run('CUDA_VISIBLE_DEVICES=0 python train_fold.py --prefix_path=/opt/ml/input/data/train/data/ --output_path=/opt/ml/output/ --cfg=DMFNet_fullpp_fold --batch_size=5', shell=True)
